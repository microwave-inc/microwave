...
class Discord_Info(commands.Cog):
    ...
    @commands.command(aliases=["joined", "join"])
    @commands.guild_only()
    ...
    async def mods(self, ctx):
        ...
        message = ""
        all_status = {
            "online": {"users": [], "emoji": "<:online:868219934264684565>"},
            "idle": {"users": [], "emoji": "<:dev:868220234149036112>"},
            "dnd": {"users": [], "emoji": "<:DND:922269063269462046>"},
            "offline": {"users": [], "emoji": "<:offline:868220565696184401>"}
        }
